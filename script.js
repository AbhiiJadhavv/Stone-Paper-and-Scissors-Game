...
const hands = {
    ...
    "stone": '<div id="stone2" class="picked"><div><img src="Stone.png" height="50px" width="70px"></div></div>',
    "paper": '<div id="paper2" class="picked"><div><img src="Paper.png" height="65px" width="65px"></div></div>',
    "scissors": '<div id="scissors2" class="picked"><div><img src="Scissors.png" height="55px" width="45px"></div></div>'
}
